...
class CategoryDataset(Dataset):
    ...
    def get_fitb_quesiton(self, index, option_len=4):
        ...
        return items, exist_parts, labels, question_part, question_id, options, option_labels
...
if __name__ == "__main__":
    ...
    loader = DataLoader(d, 4, shuffle=True, num_workers=2, collate_fn=graph_collate_fn)
