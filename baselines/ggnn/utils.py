...
class BestSaver(object):
    ...
    def __init__(self, comment=None):
        ...
        save_path = "model_ggnn_{}".format(exe_fname.split(".")[0])
...
def prepare_dataloaders(root_dir="../data/images2/", data_dir="../data/", batch_size=16, img_size=224, use_mean_img=True, neg_samples=True, num_workers=4, collate_fn=collate_fn):
