...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default="./model_auc_MLMSFF.pth")
    ...
    model = CompatModel(vocabulary=len(train_dataset.vocabulary), vse_off=args.vse_off, layer_feature_size=args.layer_feature_size).to(device)
