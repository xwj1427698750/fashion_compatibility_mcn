...
class MultiModuleGenerator(nn.Module):
    def __init__(self, embed_size=1000, need_rep=True, vocabulary=None, num_attention_heads=0,
    ...
    def forward(self, images, names):
        ...
        # 进行attention聚合操作
        if self.num_attention_heads > 0:
            features_input = self.attention_fuse(features_input)
        ...
        input_fuse_features = self.last_feature_fuse(features_input)
