...
parser.add_argument('--model_path', type=str, default="./model_train_maxpool_double_weight_(double_same_conv:out_concat_one_fcs)_(two_fuse_module)_(double_rep).pth")
