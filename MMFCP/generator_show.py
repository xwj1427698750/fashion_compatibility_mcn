...
if __name__ == '__main__':
    ...
    parser.add_argument('--enc_desc_off', action="store_false")
    parser.add_argument('--input_off', action="store_true")
    parser.add_argument('--generator_off', action="store_true")
    parser.add_argument('--MLMSFF_off', action="store_true")
